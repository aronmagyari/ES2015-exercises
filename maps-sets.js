class MessageBoard {
    ...
    */
    ...
    add a key and value to the messages map with a key of whatever the value 
    of this.id is and a value of whatever the string is that is passed to the 
    ...
    */
    ...
    /*
    Add a method called findMessageById which accepts a number and returns 
    the message in the messages map with the same key as the number passed 
    to the function. If the key is not found in the messages map, the function 
    ...
    */
    ...
    to the function. If the value is not found in the messages map, the 
    ...
    */
    ...
    /*
    Add a method called numberOfMessages which returns the number of 
    keys in the messages map
    ...
    */
    ...
    /*
    Add a method called messagesToArray which returns an array of all of 
    the values in the messages map
...
Write a function called hasDuplicates which accepts an array and returns 
true if there are duplicate values in the array, otherwise it should return false.
...
Write a function called countPairs which accepts an array and a number. 
The function should return the number of pairs (two numbers) that sum up to the 
